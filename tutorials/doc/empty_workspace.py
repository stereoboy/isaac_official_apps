...
kTemplateFilename = "apps/tutorials/doc/empty_workspace.tpl"
...
def main():
    ...
    # Copy isaac.bzl
    with open(isaac_path + "/apps/tutorials/doc/isaac.bzl.tpl") as file:
        template = Template(file.read())
    ...
    # Copy BUILD.bzl
    with open(isaac_path + "/apps/tutorials/doc/BUILD.tpl") as file:
        template = Template(file.read())
    workspace = template.substitute(dict())
